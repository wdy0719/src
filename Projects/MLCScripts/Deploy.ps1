...
$settings_email_user = "xxx@microsoft.com";
$settings_email_password = "xxx";
...
#$SOURCESDIRECTORY = "d:\Blds\318\src";
$skipeDeploy=$false;
$skipeTest=$false;
...
try{ 
  ...
  if(!$skipeTest)
   {
    ...
    RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Grid" -browser "internet explorer" -browserVer "11_7" -platform "windows"    
   # RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Grid" -browser "firefox" -browserVer "" -platform "windows"
    ...
    # mobile browsers:    
   # RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "safari" -browserVer "iPhone.5s" -platform "mac"
   # RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "safari" -browserVer "iPhone.5c" -platform "mac"
  #  RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "safari" -browserVer "iPad.4" -platform "mac"
   # RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "safari" -browserVer "iPad.mini" -platform "mac"
  ...
  #  RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "chrome" -browserVer "LGE.Nexus.5" -platform "android"
 #   RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "chrome" -browserVer "samsung.SM-G900H" -platform "android"
  #  RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "chrome" -browserVer "samsung.GT-I9505" -platform "android"
  #  RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "chrome" -browserVer "samsung.SAMSUNG-SGH-I337" -platform "android"
  #  RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "chrome" -browserVer "HTC.HTC.One_M8" -platform "android"
  #  RunTests -workDir $testDir -vstestArgs "Microsoft.Skype.SkypeCast.Test.UITests.dll /InIsolation /TestCaseFilter:TestCategory!=LocalExclusive /logger:trx" -trxBackupPrefix "SchedulerUI" -mode "Mobile" -browser "chrome" -browserVer "motorola.XT1058" -platform "android"
